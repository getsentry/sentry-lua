...
local function detect()
  ...
  if rawget(_G, "ngx") and ngx and ngx.config then return require("platforms.openresty") end
  -- Roblox: DateTime + HttpService/Game presence is a good signal
  if rawget(_G, "DateTime") and rawget(_G, "game") then return require("platforms.roblox") end

  -- Defold: global 'http' (http.request), 'sys' module, and go module exist
  if rawget(_G, "http") and rawget(_G, "sys") and rawget(_G, "go") then return require("platforms.defold") end

  -- LÖVE: global 'love' with version
  ---@diagnostic disable-next-line: undefined-global
  if rawget(_G, "love") and type(love) == "table" and love._version then return require("platforms.love2d") end
